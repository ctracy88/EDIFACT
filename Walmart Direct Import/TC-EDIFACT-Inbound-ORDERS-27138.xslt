  ...
  <xsl:template match="/">
	...
	<xsl:template match="UNH">
		...
		<PurchaseOrder>
			...
			<xsl:variable name="credit" select="NAD[Field[1] = 'HS']"/>
			...
			<Beneficiary>
				<Code>
					<xsl:value-of select="edi:getSubElement($beneficiary, 2, 1)"/>
				</Code>
				<Name>
					<xsl:value-of select="edi:getSubElement($beneficiary, 3, 1)"/>
				</Name>
				<Address1>
					<xsl:value-of select="edi:getSubElement($beneficiary, 5, 1)"/>
				</Address1>
				<Address2>
					<xsl:value-of select="edi:getSubElement($beneficiary, 5, 2)"/>
				</Address2>
				<City>
					<xsl:value-of select="edi:getElement($beneficiary, 6)"/>
				</City>
				<State>
					<xsl:value-of select="edi:getSubElement($beneficiary, 7, 1)"/>
				</State>
				<ZipCode>
					<xsl:value-of select="edi:getElement($beneficiary, 8)"/>
				</ZipCode>
				<Country>
					<xsl:value-of select="edi:getElement($beneficiary, 9)"/>
				</Country>
			</Beneficiary>
			<Broker>
				<Code>
			...
			<CreditOffice>
				<Code>
					<xsl:value-of select="edi:getSubElement($credit, 2, 1)"/>
				</Code>
				<Name>
					<xsl:value-of select="edi:getSubElement($credit, 3, 1)"/>
				</Name>
				<Address1>
					<xsl:value-of select="edi:getSubElement($credit, 5, 1)"/>
				</Address1>
				<Address2>
					<xsl:value-of select="edi:getSubElement($credit, 5, 2)"/>
				</Address2>
				<City>
					<xsl:value-of select="edi:getElement($credit, 6)"/>
				</City>
				<State>
					<xsl:value-of select="edi:getSubElement($credit, 7, 1)"/>
				</State>
				<ZipCode>
					<xsl:value-of select="edi:getElement($credit, 8)"/>
				</ZipCode>
				<Country>
					<xsl:value-of select="edi:getElement($credit, 9)"/>
				</Country>
			</CreditOffice>
			<Manufacturer>
				<Code>
				...
				<Name>
					<xsl:value-of select="edi:getSubElement($manufacturer, 3, 1)"/>
				</Name>
				<Address1>
	...
	<xsl:choose>
	<xsl:when test="$CustomerProfileId = 3654">
	<xsl:if test="self::node()[Field[4]/Field[2] = 'PACK']">
		<mapper:setVar name="packQuantity">
			<xsl:value-of select="edi:getSubElement(PAC/QTY[Field[1]/Field[1] = '21'], 1, 2)"/>
		</mapper:setVar>
	</xsl:if>
	<xsl:if test="self::node()[Field[4]/Field[2] = 'ASST']">
		<Items>
			<LIN>
				<LineNum>
				...
				<PackNum>
					<xsl:value-of select="edi:getSubElement(self::node()[Field[3]/Field[2] = 'AK'], 3, 1)"/>
				</PackNum>
				<PartNum>
				...
				<PackQuantity>
					<mapper:getVar name="packQuantity" />
				</PackQuantity>
			</LIN>
			<QTY>
				<QtyPerPack>
