    ...
    <xsl:template match="ASN">
        ...
        <UNH>
			...
			<RFF>
				...
				<DTM>
					...
					<Field>
						<Field>171</Field>
						<Field>
							<xsl:value-of select="RFF/DTM.RFF/OrderDate" />
						</Field>
						<Field>102</Field>
					</Field>
				</DTM>
			...
			<xsl:for-each select="Pack">
				...
				<PCI>
					<mapper:incVar name="segmentCount" />
					<Field><xsl:value-of select="ISORegulation" /></Field>
				</PCI>
				<GIN>
					<mapper:incVar name="segmentCount" />
						<Field>BJ</Field>
					<Field><xsl:value-of select="PackagingID" /></Field>
				</GIN>
