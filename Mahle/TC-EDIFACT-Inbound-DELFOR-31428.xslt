	...
	<xsl:template match="UNH">
		...
		<Plan>
			...
			<NAD.SF>
				...
				<Name>
					<xsl:value-of select="edi:getElement(NAD[Field[1] = 'SF'], 3)"/>
				</Name>
				<Address>
			...
			<GIS>
				...
				<NAD.ST>
					...
					<CTA>
						<ContactName>
							<xsl:value-of select="edi:getSubElement(GIS/NAD/CTA[Field[1] = 'IC'], 2, 1)"/>
						</ContactName>
					</CTA>
					<COM>
						<ContactPhone>
							<xsl:value-of select="edi:getSubElement(GIS/NAD/COM[Field[1]/Field[2] = 'TE'], 1, 1)"/>
						</ContactPhone>
					</COM>
				</NAD.ST>
