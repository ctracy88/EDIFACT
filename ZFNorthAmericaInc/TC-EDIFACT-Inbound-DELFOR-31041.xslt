...
<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="UNH">
		...
		<Plan>
			...
			<FTX>
				<TransactionNote>
					<xsl:value-of select="edi:getSubElement(FTX[Field[1]/Field[1] = 'AAI'], 1, 4)"/>
				</TransactionNote>
			</FTX>
			<NAD.MI>
				<Code>
			...
			<GIS>
				...
				<LIN>
					<LineNum>
						<xsl:value-of select="edi:getElement(GIS/LIN, 1)"/>
					</LineNum>
					<BuyersItemNum>
					...
					<RFF>
						...
						<DeliveryScheduleNum>
							<xsl:value-of select="edi:getSubElement(GIS/LIN/RFF[Field[1]/Field[1] = 'AAN'], 1, 2)"/>
						</DeliveryScheduleNum>
					</RFF>
					<DTM>
					...
					<SCC>
						...
						<SCC.QTY>
							...
							<SCC.DTM>
								<DespatchDate>
									<xsl:value-of select="edi:getSubElement(self::node()/DTM[Field[1]/Field[1] = '11'], 1, 2)"/>
								</DespatchDate>
								<DeliveryDate>
