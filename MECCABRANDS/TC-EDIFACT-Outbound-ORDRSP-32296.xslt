...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:date="com.css.base.xml.xslt.ext.XsltDateExtension" xmlns:str="com.css.base.xml.xslt.ext.XsltStringExtension" xmlns:edifact="com.css.base.xml.xslt.ext.edi.XsltParsedEdifactEdiExtension" xmlns:mapper="com.api.tx.MapperEngine" extension-element-prefixes="date mapper str edifact">
    ...
    <xsl:template match="Ordrsp">
        ...
        <UNH>
			...
			<xsl:if test="string-length(DTM/DateRequestedShip) &gt; 0">
			<DTM>
                <mapper:incVar name="segmentCount" />
                <Field>
                    <Field>10</Field>
                    <Field>
                        <xsl:value-of select="DTM/DateRequestedShip" />
                    </Field>
                    <Field>102</Field>
                </Field>
            </DTM>
			</xsl:if>
			<xsl:if test="string-length(DTM/ShipDate) &gt; 0">
			<DTM>
                <mapper:incVar name="segmentCount" />
                <Field>
                    <Field>10</Field>
                    <Field>
                        <xsl:value-of select="DTM/ShipDate" />
                    </Field>
                    <Field>102</Field>
                </Field>
            </DTM>
			...
			<xsl:for-each select="Item">
					<LIN>
						...
						<xsl:if test="string-length(LIN/MOA/LineItemAmount) &gt; 0">
						<MOA>
							<mapper:incVar name="segmentCount" />
							<Field>
								<Field>128</Field>
						...
						<xsl:if test="string-length(LIN/MOA/CustomsValue) &gt; 0">
						<MOA>
							<mapper:incVar name="segmentCount" />
							<Field>
								<Field>369</Field>
								<Field>
									<xsl:value-of select="LIN/MOA/CustomsValue" />
								</Field>
							</Field>
						</MOA>
						</xsl:if>
						...
						<mapper:incVar name="segmentCount" />
							<Field>
								<Field>ON</Field>
								<Field>
									<xsl:value-of select="LIN/RFF/PONum" />
								</Field>
								<Field>
									<xsl:value-of select="LIN/LineNum" />
								</Field>
