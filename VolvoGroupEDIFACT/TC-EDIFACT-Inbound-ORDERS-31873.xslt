...
<!--
	...
	Input: The Iconic EDIFACT D96B ORDER.
	Output: TC XML Order.
  ...
  <xsl:template match="/">
	...
	<xsl:template match="UNH">
		...
		<PurchaseOrder>
			...
			<IMD>
				<OrderType>
					<xsl:value-of select="edi:getSubElement(BGM, 3, 1)"/>
				</OrderType>
			</IMD>
			<FTX>
			...
			<RFF>
				...
				<BuyerOrderNum>
					<xsl:value-of select="edi:getSubElement(RFF[Field[1]/Field[1] = 'CO'], 1, 2)"/>
				</BuyerOrderNum>
				<CustomerRefNum>
					<xsl:value-of select="edi:getSubElement(RFF[Field[1]/Field[1] = 'CR'], 1, 2)"/>
				</CustomerRefNum>
				<POSuffix>
					<xsl:value-of select="edi:getSubElement(RFF[Field[1]/Field[1] = 'PS'], 1, 2)"/>
				</POSuffix>
			</RFF>
			<!-- Start of NADs></!-->
			...
			<xsl:variable name="Seller" select="NAD[Field[1] = 'SE']"/>
			<xsl:variable name="InvoiceTo" select="NAD[Field[1] = 'IV']"/>
			<BuyingParty>
				<Code>
				...
				<CTA>
					...
					<COM>
						...
						<ContactEmail>
							<xsl:value-of select="edi:getSubElement($BuyingParty/CTA/COM[Field[1]/Field[2] = EM], 1, 1)"/>
						</ContactEmail>
					</COM>
				</CTA>
			</BuyingParty>
			...
			<Seller>
				<Code>
					<xsl:value-of select="edi:getSubElement($Seller, 2, 1)"/>
				</Code>
				<CodeType>
					<xsl:value-of select="edi:getSubElement($Seller, 2, 3)"/>
				</CodeType>
				<Name>
					<xsl:value-of select="edi:getSubElement($Seller, 4, 1)"/>
				</Name>
				<Name2>
					<xsl:value-of select="edi:getSubElement($Seller, 4, 2)"/>
				</Name2>
				<Address1>
					<xsl:value-of select="edi:getSubElement($Seller, 5, 1)"/>
				</Address1>
				<Address2>
					<xsl:value-of select="edi:getSubElement($Seller, 5, 2)"/>
				</Address2>
				<City>
					<xsl:value-of select="edi:getElement($Seller, 6)"/>
				</City>
				<State>
					<xsl:value-of select="edi:getElement($Seller, 7)"/>
				</State>
				<ZipCode>
					<xsl:value-of select="edi:getElement($Seller, 8)"/>
				</ZipCode>
				<Country>
					<xsl:value-of select="edi:getElement($Seller, 9)"/>
				</Country>
			</Seller>
			<InvoiceTo>
				<Code>
					<xsl:value-of select="edi:getSubElement($InvoiceTo, 2, 1)"/>
				</Code>
				<CodeType>
					<xsl:value-of select="edi:getSubElement($InvoiceTo, 2, 3)"/>
				</CodeType>
				<Name>
					<xsl:value-of select="edi:getSubElement($InvoiceTo, 4, 1)"/>
				</Name>
				<Name2>
					<xsl:value-of select="edi:getSubElement($InvoiceTo, 4, 2)"/>
				</Name2>
				<Address1>
					<xsl:value-of select="edi:getSubElement($InvoiceTo, 5, 1)"/>
				</Address1>
				<Address2>
					<xsl:value-of select="edi:getSubElement($InvoiceTo, 5, 2)"/>
				</Address2>
				<City>
					<xsl:value-of select="edi:getElement($InvoiceTo, 6)"/>
				</City>
				<State>
					<xsl:value-of select="edi:getElement($InvoiceTo, 7)"/>
				</State>
				<ZipCode>
					<xsl:value-of select="edi:getElement($InvoiceTo, 8)"/>
				</ZipCode>
				<Country>
					<xsl:value-of select="edi:getElement($InvoiceTo, 9)"/>
				</Country>
			</InvoiceTo>
			<!--END NADs -->	
			<CUX>
