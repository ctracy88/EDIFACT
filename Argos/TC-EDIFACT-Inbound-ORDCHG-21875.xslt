  ...
  <xsl:template match="/">
	...
	<xsl:template match="UNH">
		...
		<PurchaseOrder>
			...
			<RFF>
				<OriginalPONum>
					<xsl:value-of select="edi:getSubElement(RFF[Field[1]/Field[1] = 'OP'], 2, 1)"/>
				</OriginalPONum>
			</RFF>
			...
			<DTM>
				<DeliveryDate>
					<xsl:value-of select="edi:getSubElement(DTM[Field[1]/Field[1] = '077'], 2, 1)"/>
				</DeliveryDate>
			</DTM>
			<FTX>
				<Note>
