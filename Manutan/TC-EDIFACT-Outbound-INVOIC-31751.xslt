    ...
    <xsl:template match="Batch">
        ...
        <Document type="EDIFACT" wrapped="false">
            ...
            <UNB>
                ...
                <Field> <!-- UNB 3 -->
                    <Field> <!-- UNB 3.1-->
                        <xsl:value-of select="/Batch/Invoice[1]/BatchReferences/GSReceiverCode" />
                    </Field>
                    <Field> <!-- UNB 3.2-->
        ...
        <UNH>
			...
			<mapper:incVar name="segmentCount" />
				...
				<Field>
					...
					<Field/>
					<Field>
						<xsl:value-of select="ALC/SpecialServicesCode" />
					</Field>
				</Field>
				<MOA>
				<mapper:incVar name="segmentCount" />
					<Field>
						<Field>8</Field>
						<Field>
							<xsl:value-of select="ALC/MOA/ChargeAmount" />
						</Field>
						<Field>EUR</Field>
						<Field>4</Field>
					</Field>
					<xsl:if test="string-length(ALC/MOA/TAX/VATRateStandard) &gt; 0">
					<TAX>
					<mapper:incVar name="segmentCount" />
						<Field>7</Field>
						<Field>VAT</Field>
						...
						<Field>
							...
							<Field/>
							<Field>
								<xsl:value-of select="ALC/MOA/TAX/VATRateStandard" />
							</Field>
						</Field>
						<Field>S</Field>
					</TAX>
					</xsl:if>
					<xsl:if test="string-length(ALC/MOA/TAX/VATRateExempt) &gt; 0">
					<TAX>
					<mapper:incVar name="segmentCount" />
						<Field>7</Field>
						<Field>VAT</Field>
						...
						<Field>
							...
							<Field/>
							<Field>
								<xsl:value-of select="ALC/MOA/TAX/VATRateExempt" />
							</Field>
						</Field>
						<Field>E</Field>
					</TAX>
