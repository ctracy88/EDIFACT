	...
	<xsl:template match="UNH">
		...
		<Plan>
			...
			<NAD.ST>
				...
				<Name>
					<xsl:value-of select="edi:getElement(NAD[Field[1] = 'ST'], 3)"/>
				</Name>
				<Address>
					...
					<SCC>
						...
						<SCC.QTY>
							...
							<SCC.DTM>
								...
								<EarliestDate>
									<xsl:value-of select="edi:getSubElement(self::node()/DTM[Field[1]/Field[1] = '64'], 1, 2)"/>
								</EarliestDate>
								<LatestDate>
									<xsl:value-of select="edi:getSubElement(self::node()/DTM[Field[1]/Field[1] = '63'], 1, 2)"/>
								</LatestDate>
								<EndDate>
