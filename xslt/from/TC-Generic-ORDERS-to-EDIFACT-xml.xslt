        ...
        <UNH>
            ...
            <DTM>
 			...
 			<NAD>
				...
				<Field><xsl:value-of select="NAD.BY/Name" />
				</Field>
				<Field></Field>
				<Field>
					<Field>
				...
				<mapper:incVar name="segmentCount" />
                    ...
                    <Field>
						<Field></Field>
						<Field>
							<xsl:value-of select="NAD.BY/CTA/ContactName" />
						</Field>
					</Field>
				</CTA>
				<COM>
				<mapper:incVar name="segmentCount" />
					<Field>
						<Field>
							<xsl:value-of select="NAD.BY/COM/ContactPhone" />
						</Field>
						<Field>TE</Field>
					</Field>
				</COM>
				...
				<mapper:incVar name="segmentCount" />
					<Field>
						<Field>
							<xsl:value-of select="NAD.BY/COM/ContactEmail" />
						</Field>
						<Field>EM</Field>
					</Field>
				</COM>
			...
			<xsl:for-each select="Item">
					<LIN>
						...
						<Field></Field>
						<Field>
							<Field><xsl:value-of select="LIN/VendorItemNumber" /></Field>
							<Field>VP</Field>
						</Field>
						<IMD>
							<mapper:incVar name="segmentCount" />
							...
							<Field>
								<Field></Field>
								<Field></Field>
								<Field><xsl:value-of select="LIN/IMD/Description" /></Field>
							</Field>
						</IMD>
						<QTY>
							<mapper:incVar name="segmentCount" />
							<Field>
								...
								<Field><xsl:value-of select="LIN/QTY/UOM" /></Field>
							</Field>
						</QTY>
						<DTM>
							<mapper:incVar name="segmentCount" />
							<Field>
								<Field>2</Field>
								<Field><xsl:value-of select="LIN/DTM/DeliveryDate" /></Field>
								<Field>102</Field>
							</Field>
						</DTM>
						<PRI>
