    ...
    <xsl:template match="Invoice">
        ...
        <UNH>
            ...
            <NAD>
				...
				<Field></Field>
				<Field>
					<xsl:value-of select="NAD.CN/Name" />
				</Field>
				<Field>
					<Field>
						<xsl:value-of select="NAD.CN/Address1" />
					</Field>
					<Field>
						<xsl:value-of select="NAD.CN/Address2" />
					</Field>
				</Field>
				<Field>
					<xsl:value-of select="NAD.CN/City" />
				</Field>
				<Field>
					<xsl:value-of select="NAD.CN/State" />
				</Field>
				<Field>
					<xsl:value-of select="NAD.CN/Zip" />
				</Field>
				<Field>
					<xsl:value-of select="NAD.CN/Country" />
				</Field>
            </NAD>
			<NAD>
                <mapper:incVar name="segmentCount" />
