...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:date="com.css.base.xml.xslt.ext.XsltDateExtension" xmlns:str="com.css.base.xml.xslt.ext.XsltStringExtension" xmlns:edifact="com.css.base.xml.xslt.ext.edi.XsltParsedEdifactEdiExtension" xmlns:mapper="com.api.tx.MapperEngine" extension-element-prefixes="date mapper str edifact">
    ...
    <xsl:template match="Invoice">
        ...
        <UNH>
			...
			<xsl:if test="string-length(NAD.RE/Name) &gt; 0">
			<NAD> <!-- NAD.RE -->
                <mapper:incVar name="segmentCount" />
                <Field>RE</Field>
                <Field>
                    <Field>
                        <xsl:value-of select="NAD.RE/Code" />
                    </Field>
                    <Field/>
                    <Field>
						<xsl:value-of select="NAD.RE/CodeType" />
					</Field>
				</Field>
				<Field/>
				<Field>
					<Field>
						<xsl:value-of select="NAD.RE/Name" />
					</Field>
					<Field>
						<xsl:value-of select="NAD.RE/Name2" />
					</Field>
				</Field>
				<Field>
					<Field>
						<xsl:value-of select="NAD.RE/Address" />
					</Field>
					<Field>
						<xsl:value-of select="NAD.RE/Address2" />
					</Field>
				</Field>
				<Field>
					<xsl:value-of select="NAD.RE/City" />
				</Field>
				<Field>
					<xsl:value-of select="NAD.RE/State" />
				</Field>
				<Field>
					<xsl:value-of select="NAD.RE/ZipCode" />
				</Field>
				<Field>
					<xsl:value-of select="NAD.RE/Country" />
				</Field>
			</NAD>
			</xsl:if>
			<NAD> <!-- NAD.ST -->
