    ...
    <xsl:template match="Invoice">
        ...
        <UNH>
			...
			<NAD>
				...
				<Field>
					<Field>
						<xsl:value-of select="NAD.PR/Address1" />
					</Field>
				</Field>
				<Field>
					...
					<LIN>
						...
						<QTY>
							...
							<Field>
								<Field>12</Field>
								<Field>
									<xsl:value-of select="LIN/QTY/ShippedQty" />
								</Field>
							</Field>
						</QTY>
						<QTY>
						...
						<mapper:incVar name="segmentCount" />
							<Field>7</Field>
							<Field>
								<xsl:value-of select="LIN/TAX/TaxCategory" />
							</Field>
							<Field></Field>
							<Field></Field>
							<Field>
			...
			<MOA>
				...
				<Field>
					<Field>139</Field>
					<Field>
						<xsl:value-of select="MOA/AmtDueAmtPayable" />
					</Field>
				</Field>
			</MOA>
			<MOA>
				...
				<Field>
					<Field>176</Field>
					<Field>
						<xsl:value-of select="MOA/TotalTaxesAmount" />
					</Field>
				</Field>
			</MOA>
			<MOA>
			...
			<TAX>
				...
				<Field>7</Field>
				<Field>
					<xsl:value-of select="TAX/VATTaxType" />
				</Field>
				<Field></Field>
				<Field></Field>
				<Field>
